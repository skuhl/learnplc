...
<div class="lesson-statement">
	<p>
        This is a tutorial section for those who are not familiar with the PLC ladder logic programming,
	...
	<ul>
		<li> Firstly, let’s get to know the interface.
            ...
            <b><i>One suggestion: always expand the PLC window before you build any logic.</i></b>
		...
		<li>
            ...
            In the simulation window, you will see two buttons: “simulate” will simulate your ladder logic program,
    ...
    <h4> 4.	Additional building tips </h4>
    <ul>
        <li>
            Double click on any ladder logic component will give you an input box. Now, type in the correct name (from I/O list in the simulation window)
            and hit "ENTER". This does the same as drag and drop a I/O onto the ladder logic component.<br><br>
        </li>
        <li>
            Right click on any ladder logic components or rungs will give you the option of "DELETE", "RENAME", "MARK" OR "UNMARK" the component.
            Go ahead right click on components and try each different options.<br><br>
        </li>
        <li>
            Adding new rung can be done by drag the rung component onto the "rung number" of the rung after which you want insert your new rung.<br><br>
        </li>
        <li>
            Deleting a rung can be done by right click on the "rung number" and select "delete" option.<br><br>
        </li>
        <li>
            If you make any mistakes during building process, you can click on the "UNDO" button to undo the last few changes you made.
        </li>
    </ul>
</div>@stop
...
<div class="lesson-statement">
	<p>
		If you are done with this tutorial, please click on "Submit Answer" and "continue" to go the the next section.
	</p>
</div>
@stop
