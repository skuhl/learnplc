...
@section('instructions')
	...
	<div class="lesson-statement">
		<p>Turn on the pumps and valves in the correct order. Once the correct order is
			achieved, the filter tank will begin
			pumping water into the filter and cleaning it if you are correct. When you have accomplished
