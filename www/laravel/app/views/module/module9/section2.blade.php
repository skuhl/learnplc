...
@section('title','Subtraction Instruction ')
...
@section('lesson')
<div class="lesson-title">Subtraction Instruction</div>
<div class="lesson-statement">
	<div class="subsection">
        <h4>1. Theory</h4>
		<p>
            &nbsp &nbsp &nbsp Much like the <b>ADD</b> instruction, the subtraction <b>(SUB)</b> Instruction is an output instruction that allows the programmer
            to find the difference between two values stored in memory. Unlike the ADD instruction, however, which value you assign to what source matters.<br><br>

            &nbsp &nbsp &nbsp When using the <b>SUB</b> instruction, the program will subtract the value stored in the memory location allocated to <b>source B</b>
            from that stored in the memory location allocated to <b>source A</b>.
	...
	<div class="subsection">
        <h4>2. Example</h4>
		<p>
            &nbsp &nbsp &nbsp For example, if you want to find the difference between 15 and 8, the program would be as follows:<br><br>

            &nbsp &nbsp &nbsp Memory Location 1: 8<br>
            &nbsp &nbsp &nbsp Memory Location 2: 15<br><br>

            &nbsp &nbsp &nbsp Source A: Memory Location 2<br>
            &nbsp &nbsp &nbsp Source B: Memory Location 1<br><br>

            &nbsp &nbsp &nbsp The program will take the value from memory location 1 (Source B) and subtract it from the value stored in memory location 2 (Source A). <br>
            The resultant mathematical equation is:<br><br>

            Value Memory Location 3 = Source A - Source B<br>

            Value Memory Location 3 = Value Memory Location 2 - Value Memory Location 1<br>

            Value Memory Location 3 = 15 - 8<br>

            Value Memory Location 3 = 7<br><br>
