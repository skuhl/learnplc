...
@section('title','Multiplication Instruction ')
...
@section('lesson')
<div class="lesson-title">Multiplication Instruction </div>
<div class="lesson-statement">
	<div class="subsection">
		<p>
            &nbsp &nbsp &nbsp The multiplication instruction (MUL) performs the multiply arithmetic operation to the two memory location allocated to <b>Source A</b> and <b>Source B</b>.
            The result is then stored in the memory location allocated to <b>Dest</b>.<br><br>

            &nbsp &nbsp &nbsp The <b>MUL</b> instruction is great for allowing the programmer to scale a data set, such as if a counter counts every 10 boxes,
            you can determine the exact number of boxes by multiplying the accumulated value of the counter by 10.<br><br>

            &nbsp &nbsp &nbsp Much like the <b>ADD</b> instruction, it doesn’t make a difference which value is assigned to <b>Source A and Source B</b>.
            <br><br>
		</p>
	</div>
