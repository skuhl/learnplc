				...
				<td class="left-cell" valign="top" style="padding:0">
					<div class="top-bar">
						<div class="center-content">
							<div style="display: block; margin-left: 30px;" id="btn-lessons" class="btn-group pull-left">
						...
						<div id="min-left" class="arrows"  title="Slide Left" data-placement="left" data-toggle="tooltip" style="color: rgb(90, 97, 101); float: right; margin-right: 0px;"> 
                    		<span id="min-icon"  class="glyphicon glyphicon-chevron-left"></span>
                		</div>
					</div>

					<div class="content content-view wt">
						<div class="mywrapper center-content" style="border-left: 1px solid #D9D9D9; border-right: 1px solid #D9D9D9">
				...
				<td class="right-cell wt" valign="top" style="padding:0">
					<div class="mywrapper">
						<div class="exercise-panel">
							<div id="min-right" class="arrows" data-toggle="tooltip" data-placement="right" title="Slide Right"> 
								<span id="min-icon" class="glyphicon glyphicon-chevron-right"></span>  
							</div>
						</div>
						<div id="editor" style="background-color: #ecf0f1">
							<div class="exercise-pane center-content" style="min-height:400px;margin-top:0px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
								@yield('exercise')
							</div>
						</div>
						<div class="submit-panel">
							...
							<div class="eval-nav center-content">
								...
								<div id='submit-new' class='submit-section'>	
									...
									<button class="@yield('submit-class', 'submit') btn btn-primary" type='button'>Submit</button>
								</div>

								<div id='submit-correct' class='submit-section'>
										<!-- Case: section has been correctly answered previously -->
										<button class="@yield('submit-class', 'submit') btn btn-success" type='button'><span class="glyphicon glyphicon-ok"></span> Resubmit</button>
								...
								<div id='submit-incorrect' class='submit-section'>
									...
									<button class="@yield('submit-class', 'submit') btn btn-danger" type='button'><span class="glyphicon glyphicon-remove"></span> Resubmit</button>
									<button class='continue btn btn-danger' type='button'>Skip <span class="glyphicon glypihcon-step-forward"></span></button>
									<label style="color: #d9534f">Incorrect. You may try again, or skip to the next section</label>
								</div>
...
<script type="text/JAVASCRIPT">
	$(document).ready(function() {
		...
		//init tooltip
	 	...
	 	// Removes (sort of. More like draws over) the footer in any section view
		...
		$.ajax({
			...
			success: function(data) {
				...
				data.forEach(function(entry) {
					...
					$(question).removeClass (function (index, css) {
					    return (css.match (/(^|\s)has-\S+/g) || []).join(' ');
					});
					$(question).children('input').removeClass (function (index, css) {
					    return (css.match (/(^|\s)bg-\S+/g) || []).join(' ');
					});

					$(question).addClass('has-' + entry[2]);
					$(question).children('input').addClass('bg-' + entry[1]);
				});
				...
				//Run after request has been posted
