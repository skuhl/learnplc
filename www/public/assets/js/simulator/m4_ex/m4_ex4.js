...
//    answer_flag = m4_ex4_case(answer_flag, test_case_dialog, depth, length, LDL_answer[depth]);



}

//function m4_ex4_case(flag, dialog, depth, length, row){
//    if(depth < length) {
//        if(row[0]==1) {
//            click_switch(1);
//        }
...
//
//                depth += 1;
//                m4_ex4_case(flag, dialog, depth, length, LDL_answer[depth])
//            }, 500);
//        }, 500);
//    }
//    else{
