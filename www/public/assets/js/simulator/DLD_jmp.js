$(function () {
    $.widget("plc.jmp", {
        ...
        _create: function () {
            ...
            //        break;
            //}
            icon.attr("src", "/public/assets/icon/simulator/JMP_tools.png");
            node.append(icon);
            ...
            this.element.contextMenu({
                ...
                items: {
                    ...
                    2: {name: "Delete", icon: "delete",
                        callback: function (key, options) {
                            var delete_line = $($(this).parent()).mcr("option", "line");
                            var delete_offset = $($(this).parent()).mcr("option", "offset");

                            deleteElement($($(this).parent()).mcr("option", "LDL"), delete_line, delete_offset);
